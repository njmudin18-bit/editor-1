              ...
              <div class="card-body p-3">
                ...
                <form id="login_form" action="#">
                  <div class="form-group mb-2">
                    ...
                    <input class="form-control" type="text" id="username" name="username" required="required" placeholder="Enter your username" value="njmudin" autocomplete="off">
                  </div>
                  <div class="form-group mb-2">
                    <!-- <a href="pages-recoverpw.html" class="text-muted float-end"><small>Forgot your password?</small></a> -->
                    <label for="password" class="form-label">Password</label>
                    <div class="input-group input-group-merge">
                      <input type="password" id="password" name="password" class="form-control" placeholder="Enter your password" value="1234567" autocomplete="off">
